            ...
            <tr key={payment.id}>
              ...
              <td>
                <div className={styles.buttons}>
                  ...
                  {/* 22 send sms button with user's phone and specifing the payment amount on the user's default messaging app */}
                 
                 { userLive.isSystemAdmin === true && ( <SendSMS payment={payment} />)}
                </div>
              </td>
            </tr> 
          ))}
